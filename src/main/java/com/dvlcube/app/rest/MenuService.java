...
public class MenuService implements MxService {
	...
	public List<MenuGroupVo> get() {
		...
		final List<MenuGroupVo> menuGroups = new ArrayList<>();
                ...
                menuGroups.add(new MenuGroupVo(Menu.MAIN));
                menuGroups.add(new MenuGroupVo(Menu.CONFIGURATION));
                menuGroups.add(new MenuGroupVo(Menu.STATS));

		ClassPathScanningCandidateComponentProvider scanner = new ClassPathScanningCandidateComponentProvider(false);
		scanner.addIncludeFilter(new AnnotationTypeFilter(MenuItem.class));

		scanner.findCandidateComponents(this.getClass().getSimpleName()).forEach(definition -> {
